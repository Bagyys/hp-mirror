...
exports.handleLock = async(req, res) => {
    ...
    try {
        ...
        console.log("no lock found by id");
        console.log("send error");
        return res.status(404).send("nepravelnyj id 3");
    }
    ...
    if (data.o1 === "0" && data.o2 === "0" && data.n2 === "0") {
        ...
        if (dataInDb.o1 == 0 && dataInDb.o2 == 0) {
            ...
            const result = `A3%nm*Wb&id=${data.id}&i1=${i1}&$i2=${i2}&i3=${i3}&i4=${i4}&i5=${i5}&i6=${i6}&i7=${i7}&i8=${i8}&i9=${i9}&n1=${n1}&n2=${n2}&n3=${n3}&o1=${o1}&o2=${o2}&o3=${o3}&t=${t}&e=${e}`;
        ...
        if (
            ...
            try {
                ...
                console.log("send error");
                console.log(error);
                return res.status(404).send("nepravelnyj id 4");
            }
            ...
            try {
                ...
                console.log("no lock found by id");
                console.log("send error");
                return res.status(404).send("nepravelnyj id 5");
            }
            // get values to return from updated lock
            const {
                i1,
