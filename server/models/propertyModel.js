...
const propertySchema = new Schema(
  {
    ...
    location: {
      ...
      // Temporary solution coordinates are written by hands
    ...
    facilities: {
      ...
      workspace: { type: Boolean, required: true },
      ...
      bedsInTotal: {
        single: { type: Number, required: true, default: 0 },
        double: { type: Number, required: true, default: 0 },
      },
    ...
    discount: {
      more1Week: { type: Boolean, required: true },
      more1Month: { type: Boolean, required: true },
    },
  },
  { timestamps: true }
);
