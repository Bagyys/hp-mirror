...
export const fakeData: PropertyInterface[] = [
  {
    ...
    title: "Testinis",
    description:
      "Studio appartment with a prival bathroom with a heart of Hamburg equipped with all the amenities. An appartment is bright with a large windown, a newly renovated bathroom and two panoramic terrace with sunbeds",
    ...
    facilities: {
      ...
      beds: 2,
      bedrooms: 1,
      bedsInTotal: { single: 1, double: 1 }, //pakeiciau, kad gauti kieki ir kokios lovos yra
    },
    lock: "Lock",
    services: {},
    occupiedTime: [
